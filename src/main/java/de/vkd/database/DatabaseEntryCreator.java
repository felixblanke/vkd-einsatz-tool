 ...
 *
 * @param <E>
 * @author Felix The type of the entry, that will be created
 */
public class DatabaseEntryCreator<E> {
   ...
   * @param argNames The names of the parameters, that the {@link ObjectCreator} uses, to create an
   *                 entry
   */
  ...
  public E create(String... args) throws ReadDataException {
    if (args.length != argNames.length) {
      throw new ReadDataException("Invalid arg length");
    }
